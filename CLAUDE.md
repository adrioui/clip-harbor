...
- Fallback bridge downloads respect client cancellation, kill timed-out `yt-dlp` process groups, request identity-encoded media streams, and skip avoidable yt-dlp comment/cache work.
